...
Every update to the `main` branch is built with the same SDK image by GitHub Actions. A successful build creates a GitHub release with autogenerated release notes and attaches `OPDSClient.app`.
